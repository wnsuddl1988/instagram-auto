...
// task: golden-sample-chatgpt-playwright-v3-1-tts-first-mux-audit-v1
//
...
// 사용: node scripts/run-golden-sample-chatgpt-playwright-v3-1-tts-first-mux-audit.mjs --allow-live-tts
...
const CONFIG_PATH = join(__dirname, "fixtures", "golden_sample_t1_lifestyle_inflation_tts_first_mux_manifest.v3_1.json");
...
async function stageTts() {
  ...
  writeFileSync(alignPath, JSON.stringify({
    schemaVersion: "elevenlabs_alignment_raw_v3_1",
...
const manifest = {
  schemaVersion: "golden_sample_visual_render_manifest_t1_v3_1_tts_anchored",
  taskId: cfg.taskId,
...
writeFileSync(P("timingSummary"), JSON.stringify({
  schemaVersion: "elevenlabs_tts_timing_summary_v3_1",
...
writeFileSync(P("scriptPreview"), JSON.stringify({
  schemaVersion: "golden_sample_story_script_preview_v3_1",
...
writeFileSync(P("captionTimeline"), JSON.stringify({
  schemaVersion: "golden_sample_dynamic_caption_timeline_tts_anchored_v3_1",
...
const audit = {
  schemaVersion: "post_render_artifact_audit_tts_mux_v3_1",
