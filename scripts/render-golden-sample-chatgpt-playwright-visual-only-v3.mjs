/**
 * Golden Sample — ChatGPT+Playwright Visual-Only Candidate Renderer v3 (fresh set)
 * task: golden-sample-chatgpt-playwright-fresh-image-set-visual-only-v3
 *
 * v2 renderer 대비 변경:
...
const BLUEPRINT = join(REPO_ROOT, "scripts", "fixtures", "golden_sample_t1_lifestyle_inflation_story_blueprint.v3.json");
const OUT_DIR = "C:/tmp/money-shorts-os/golden-sample-chatgpt-playwright-visual-only-v3";
...
if (blueprint.schemaVersion !== "golden_sample_story_blueprint_v3") fail("blueprint v3 schema 불일치", 12);
...
const SCENES = [
  { id: "s1", img: "img_31_hook_envelope_vs_empty_jar",      t0: 0.0,  t1: 4.2,  zs: 1.02, ze: 1.08, eq: "brightness=-0.04:contrast=1.0:saturation=1.04",  blur: 0 },
  ...
  { id: "s3", img: "img_33_causeA_orderly_fixed_outflow",    t0: 8.8,  t1: 13.4, zs: 1.02, ze: 1.08, eq: "brightness=-0.04:contrast=1.01:saturation=1.02", blur: 0 },
  ...
  { id: "s5", img: "img_35_illusion_one_bill_vs_receipt_wall",t0: 18.6, t1: 23.6, zs: 1.02, ze: 1.07, eq: "brightness=-0.05:contrast=1.02:saturation=1.0",  blur: 0 },
  ...
  { id: "s7", img: "img_37_actionA_dividing_into_jars",      t0: 28.0, t1: 31.6, zs: 1.03, ze: 1.08, eq: "brightness=0.0:contrast=1.0:saturation=1.04",    blur: 0 },
  { id: "s8", img: "img_38_actionB_three_jars_color_ribbons",t0: 31.6, t1: 36.8, zs: 1.02, ze: 1.07, eq: "brightness=0.0:contrast=1.0:saturation=1.05",    blur: 0 },
...
// s1 — hook (0–4.2): 봉투/병은 하단, 텍스트 상단
ov("ov01_hook_l1", 0.15, 4.2, [
  { type: "text", x: 540, y: 560, fs: 104, fill: COL.white, stroke: S + 1, text: T("월급은 올랐는데") },
]);
ov("ov02_hook_l2", 0.8, 4.2, [
  { type: "text", x: 540, y: 716, fs: 120, fill: COL.yellow, stroke: S + 1, text: T("통장은 그대로") },
  { type: "rect", x1: 330, y1: 796, x2: 750, y2: 812, fill: COL.yellow },
]);
ov("ov03_hook_cap", 2.5, 4.2, [
  { type: "text", x: 540, y: 1520, fs: 62, fill: COL.white, stroke: S - 1, text: T("느낌이 아니라 사실") },
]);
...
const specPath = join(OUT_DIR, "overlay_spec.v3.json");
...
const outMp4 = join(OUT_DIR, "golden_sample_t1_lifestyle_inflation_visual_only_v3.mp4");
{
...
const manifest = {
  schemaVersion: "golden_sample_chatgpt_playwright_visual_only_render_manifest_v3",
  taskId: "golden-sample-chatgpt-playwright-fresh-image-set-visual-only-v3",
  createdAt: new Date().toISOString(),
  topicId: blueprint.topicId,
  blueprint: "scripts/fixtures/golden_sample_t1_lifestyle_inflation_story_blueprint.v3.json",
...
writeFileSync(join(OUT_DIR, "render_manifest.v3.json"), JSON.stringify(manifest, null, 2), "utf8");
