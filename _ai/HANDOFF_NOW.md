...
`creative-v2-flux2-small-validation-v1`
...
- Run the separately approved FLUX2 small validation only.
- Generate at most 4 FLUX.2 [pro] images using the strengthened benchmark-derived no-text prompt contract.
