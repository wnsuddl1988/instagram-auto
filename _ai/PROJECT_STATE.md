...
- HEAD: `67bfd89` — `feat(source-facts): add scene label safe-zone contract` ← **현재 HEAD**
- Commit: `fe6437f` — `feat(source-facts): add caption system v1 safe-zone qa`
