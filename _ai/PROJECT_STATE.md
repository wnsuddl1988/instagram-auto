...
- HEAD: `361de7b` — `docs(state): clean route smoke checkpoint state` ← **현재 HEAD**
...
- Uncommitted: `money-shorts-os-caption-system-safe-zone-qa-v1` (3 files modified, static guard 56/56 PASS)
- Push: 미실행
