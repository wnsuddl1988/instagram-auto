...
export const MONEY_SHORTS_UNATTENDED_POLICY_VERSION =
  "money_shorts_unattended_policy_v1";
...
/**
 * Builds a proposal-only Owner policy card from already computed queue views.
 * It grants no authority, writes no state, and cannot activate any profile.
 */
export function buildMoneyShortsUnattendedPolicyPreview({
  ...
  return {
    ...
    reason: "현재 외부·유료·QA·게시 단계는 Owner 확인에서 멈춥니다. 첫 확장은 1~3회 로컬 무전송 작업만 허용하는 것이 가장 안전합니다.",
