...
export function mergeYoutubeRefreshTokenRuntimeCounters({
  result,
  externalRequestCount,
  ...
  return {
    ...result,
    externalRequestCount: Math.max(
      safeCount(result?.externalRequestCount),
      safeCount(externalRequestCount),
    ),
    oauthBrowserOpenCount: Math.max(
      safeCount(result?.oauthBrowserOpenCount),
      safeCount(oauthBrowserOpenCount),
    ),
  };
}
